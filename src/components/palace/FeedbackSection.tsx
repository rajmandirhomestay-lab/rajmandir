...
export const FeedbackSection = () => {
  ...
  return (
    <section ref={ref} className="relative py-32 px-6 overflow-hidden bg-[#74a6d6] border-b border-[#528dbf]">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.15),transparent_60%)]" />

      <div className="relative max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <div className="eyebrow mb-4 font-serif-sc text-[#0a3560] tracking-[0.5em] text-xs font-bold uppercase">★ THE GUESTBOOK ★</div>
          <h2 className="font-display text-5xl md:text-6xl text-[#071829] font-bold">
            Whispers from <span className="text-[#0a3560] italic">our guests</span>
          </h2>
