...
export const About = () => {
  ...
  return (
    <section id="about" ref={ref} className="relative py-32 px-6 bg-[#eaf4fb] text-[#091a26] overflow-hidden border-b border-[#9ed1ee]/40">
      <div className="absolute inset-0 opacity-[0.04] [background-image:radial-gradient(#20638b_1px,transparent_1px)] [background-size:24px_24px]" />
      ...
      <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="about-text">
          <div className="font-serif-sc text-[#20638b] tracking-[0.5em] text-xs mb-4 font-bold">★ OUR STORY ★</div>
          <h2 className="font-display text-5xl md:text-6xl leading-tight text-[#091a26] font-bold">
            A Legacy of <span className="text-[#20638b] italic">Warm Welcome</span>.
          </h2>
          <div className="divider-gold mt-6 max-w-xs">
            <span className="font-display text-[#20638b] text-xl">❖</span>
          </div>
          <p className="mt-8 font-serif text-xl leading-relaxed text-[#13374f] font-normal">
          ...
          <p className="mt-5 font-serif italic text-lg leading-relaxed text-[#13374f]">
            Today, our family opens these doors as guardians — not owners —
            inviting travelers to walk softly through history.
          </p>

          <div className="stats-row mt-12 grid grid-cols-3 gap-6 border-t border-[#9ed1ee]/40 pt-10">
            {[
              ...
              <div key={s.l} className="about-stat text-center">
                <div className="font-display text-4xl md:text-5xl text-[#20638b] font-bold">{s.n}</div>
                <div className="mt-2 font-serif-sc text-[10px] tracking-[0.3em] text-[#13374f] font-semibold">{s.l}</div>
              </div>
            ))}
          </div>
