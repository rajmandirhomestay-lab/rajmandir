  ...
  return (
    <section ref={ref} className="relative min-h-[92vh] w-full overflow-hidden flex items-center justify-center pt-32 pb-20">
      <div ref={imgRef} className="absolute inset-0 will-change-transform">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-royal-deep/50 via-royal-deep/30 to-background" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_25%,hsl(var(--royal-deep)/0.75))]" />
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <h1 className="ph-title font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl leading-[0.95] text-ivory drop-shadow-[0_4px_30px_hsl(var(--royal-deep)/0.8)]">
        ...
        <p className="ph-sub mt-6 font-serif italic text-lg md:text-2xl text-ivory/85 max-w-2xl mx-auto leading-relaxed">
          {subtitle}
        </p>
      </div>
